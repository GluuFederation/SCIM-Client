...
public class ScimClientBulkOperationsTest  extends BaseScimTest{
	...
	@BeforeTest
	public void init(final String domain, final String umaMetaDataUrl, final String umaAatClientId, final String umaAatClientJwks, @Optional final String umaAatClientKeyId , final String username) throws IOException {
