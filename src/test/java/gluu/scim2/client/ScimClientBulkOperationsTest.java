...
public class ScimClientBulkOperationsTest  extends BaseScimTest{
	...
	@Parameters({ "domainURL", "umaMetaDataUrl", "umaAatClientId", "umaAatClientJwks" , "umaAatClientKeyId" , "ScimClientBulkOperationsTest.username", "id" })
	@BeforeTest
	public void init(final String domain, final String umaMetaDataUrl, final String umaAatClientId, final String umaAatClientJwks, @Optional final String umaAatClientKeyId , final String username, final String groupName) throws IOException {
		...
		REQUESTJSON = REQUESTJSON.replaceAll("<test_group_inum>", groupName);
		response = null;
		BulkResponse = null;
	}
