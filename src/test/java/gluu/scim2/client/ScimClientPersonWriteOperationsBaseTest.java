...
public class ScimClientPersonWriteOperationsBaseTest  extends BaseScimTest{
	...
	@Parameters({ "domainURL", "umaMetaDataUrl", "umaAatClientId", "umaAatClientJwks" , "umaAatClientKeyId" , "userjson.add.username" , "userjson.update.givenname", "group1Inum"})
	@BeforeTest
	public void init(final String domain, final String umaMetaDataUrl, final String umaAatClientId, final String umaAatClientJwks, @Optional final String umaAatClientKeyId ,  String username,  String updateGivenName, final String group1Inum) throws IOException {
		...
		CREATEJSON = CREATEJSON.replaceAll("<test_group_inum>", group1Inum);
