...
public class ScimClientBulkOperationsTest extends BaseScimTest {
	...
	@BeforeTest
	public void init(final String domain, final String umaMetaDataUrl, final String umaAatClientId, final String umaAatClientJwks, @Optional final String umaAatClientKeyId, final String group1Inum, final String group2Inum) {
		try {
		...
		REQUESTJSON = REQUESTJSON.replaceAll("<test_group_inum>", group1Inum).replaceAll("<test_group2_inum>", group2Inum);
	}
