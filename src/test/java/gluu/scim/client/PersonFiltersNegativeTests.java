 ...
 * @author Val Pecaoco
 */
public class PersonFiltersNegativeTests extends BaseScimTest {
    ...
    public void testNullFilterParams() throws Exception {
        ...
        ScimResponse response = client.searchPersons(null, 0, 0, null, null, null);
    ...
    public void testEmptyFilterParams() throws Exception {
        ...
        ScimResponse response = client.searchPersons("", 0, 0, "", "", new String[]{""});
    ...
    public void testMoreThanMaxCount() throws Exception {
        ...
        ScimResponse response = client.searchPersons("", 0, (MAX_COUNT + 1), "", "", new String[]{""});
