...
public interface ClientSideUserService extends IUserWebService, CloseableClient {
    ...
    /**
     * Invokes a service method that allows to create a User resource via POST (as per section 3.3 of RFC 7644)
     * @param jsonUser A String with the payload for the operation
    ...
    /**
     * Invokes a service method that allows to update a User resource via PUT (see section 3.5.1 of RFC 7644)
     * @param jsonUser A String with the payload for the update
    ...
    /**
     * Invokes a service method that allows to update a User resource via PATCH (see section 3.5.2 of RFC 7644). Note that
