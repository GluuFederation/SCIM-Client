 ...
 */
public class OAuthScim2ClientImpl extends BaseScim2ClientImpl {
	...
	public OAuthScim2ClientImpl(String userName, String passWord, String clientID, String clientSecret, String domain,
	...
	public OAuthScim2ClientImpl(String accessToken, long accessTokenExpiration, String domain, String oAuthTokenEndpoint) {
		super(domain);
